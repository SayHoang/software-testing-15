...
if (expected_result == 'success') {
    WebUI.verifyElementPresent(findTestObject('Object Repository/Page_CURA Healthcare Service/h2_MakeAppointment'), 0)

    WebUI.comment('Login success with: ' + username)
} else {
    WebUI.verifyElementPresent(findTestObject('Object Repository/Page_CURA Healthcare Service/h2_LoginFailed'), 0)
